...
export { FacebookAdsApi, Ad, AdAccount, AdAccountRoas, AdAccountTargetingUnified, AdAccountUser, AdActivity, AdAsyncRequest, AdAsyncRequestSet, AdCreative, AdImage, AdKeywordStats, AdLabel, AdPlacePageSet, AdPreview, AdReportRun, AdsDataPartner, AdSet, AdsInsights, AdsPixel, AdsPixelStatsResult, BroadTargetingCategories, Business, BusinessAdAccountRequest, BusinessPageRequest, Campaign, CustomAudience, CustomAudiencePrefillState, CustomAudienceSession, CustomAudiencesTOS, Domain, Event, EventSourceGroup, ExternalEventSource, Hotel, Lead, LeadgenForm, LegacyBusinessAdAccountRequest, MinimumBudget, OffsitePixel, PartnerCategory, ProductCatalog, ProductCatalogHotelRoomsBatch, ProductCatalogPricingVariablesBatch, ProductFeed, ProductFeedUpload, ProductFeedUploadError, ProductFeedUploadErrorSample, ProductGroup, ProductItem, ProductSet, ProfilePictureSource, RateCard, ReachEstimate, ReachFrequencyPrediction, TargetingSentenceLine, Transaction, User };
